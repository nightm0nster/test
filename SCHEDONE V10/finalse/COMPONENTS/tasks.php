...
<body>
    ...
    <div class="popup-content">
        ...
        <input type="number" id="fontSize" min="10" max="24" step="1">
        </div>
        ...
        <input type="color" id="colorCoding">
        </div>
    ...
    <script>
        ...
        // Store original styles of the table cells
        ...
        // Reload the page with the updated sort parameter
